export const employees = [
  ...
  },
  {
    ...
    code: "HL-003",
    name: "Lê Minh Khang",
    department: "Phòng Bán hàng online",
...
export const departments = [
  {
    ...
    businessUnit: null,
    description: "Đơn vị gốc của toàn bộ cây tổ chức SRG.",
  ...
  },
  {
    ...
    businessUnit: "helios",
    description: "Khối kinh doanh Helios.",
    isManagementUnit: true
  },
  {
    id: "org-helios-hr",
    ...
    departmentType: "department",
    businessUnit: "hr",
    description: "Phụ trách hành chính và nhân sự của Helios.",
    isManagementUnit: false
  },
  {
    id: "org-helios-accounting",
    code: "SRG-002-002",
    name: "Phòng Kế toán",
    headId: null,
    parentId: "org-helios",
    ...
    description: "Phụ trách kế toán và kiểm soát tài chính của Helios.",
    isManagementUnit: false
  },
  {
    id: "org-helios-media",
    ...
    description: "Phụ trách nội dung hình ảnh và truyền thông.",
    isManagementUnit: false
  },
  {
    id: "org-helios-product",
    code: "SRG-002-004",
  ...
  },
  {
    ...
    departmentType: "department",
    businessUnit: "marketing",
    description: "Phụ trách marketing cho khối Helios.",
    isManagementUnit: false
  },
  {
    id: "org-helios-global",
    code: "SRG-002-006",
    name: "Global",
    headId: null,
    parentId: "org-helios",
    ...
    description: "Phụ trách hoạt động kinh doanh quốc tế.",
    isManagementUnit: false
  },
  {
    id: "org-helios-warehouse",
    code: "SRG-002-007",
    name: "Kho vận",
    headId: null,
    parentId: "org-helios",
    ...
    description: "Phụ trách kho và vận chuyển hàng hóa.",
    isManagementUnit: false
  },
  {
    id: "org-helios-production",
    code: "SRG-002-008",
    name: "Xưởng Sản xuất",
    headId: null,
    parentId: "org-helios",
    ...
    departmentType: "department",
    businessUnit: "operations",
    description: "Đơn vị sản xuất thuộc Helios.",
    isManagementUnit: false
  },
  {
    id: "org-helios-assistant",
    code: "SRG-002-009",
    name: "Trợ lý",
    headId: null,
    parentId: "org-helios",
    ...
    departmentType: "department",
    businessUnit: "management",
    description: "Bộ phận trợ lý và hỗ trợ điều hành.",
    isManagementUnit: false
  },
  {
    id: "org-helios-supply",
    code: "SRG-002-010",
    name: "Phòng Cung ứng",
    headId: null,
    parentId: "org-helios",
    ...
    departmentType: "department",
    businessUnit: "operations",
    description: "Phụ trách mua hàng và cung ứng.",
    isManagementUnit: false
  },
  {
    id: "org-helios-back-office",
    code: "SRG-002-011",
    name: "Back Office",
    headId: null,
    parentId: "org-helios",
    ...
    departmentType: "department",
    businessUnit: "operations",
    description: "Bộ phận hỗ trợ vận hành nội bộ.",
    isManagementUnit: false
  },
  {
    id: "org-helios-sales",
    ...
    departmentType: "department",
    businessUnit: "sales",
    description: "Quản lý các kênh và điểm bán hàng của Helios.",
    isManagementUnit: true
  },
  {
    id: "org-helios-sales-online",
    code: "SRG-002-012-001",
    name: "Phòng Bán hàng online",
    headId: "emp-003",
    parentId: "org-helios-sales",
    permissionStructure: "branch",
    departmentType: "branch",
    businessUnit: "sales",
    description: "Kênh bán hàng trực tuyến của Helios.",
    isManagementUnit: false
  },
  {
    id: "org-helios-store-le-thanh-nghi",
    code: "SRG-002-012-002",
    name: "CH Lê Thanh Nghị",
    headId: null,
    parentId: "org-helios-sales",
    permissionStructure: "branch",
    departmentType: "branch",
    businessUnit: "sales",
    description: "Cửa hàng Helios tại Lê Thanh Nghị.",
    isManagementUnit: false
  },
  {
    id: "org-helios-store-nguyen-trai",
    code: "SRG-002-012-003",
    name: "CH Nguyễn Trãi",
    headId: null,
    parentId: "org-helios-sales",
    permissionStructure: "branch",
    departmentType: "branch",
    businessUnit: "sales",
    description: "Cửa hàng Helios tại Nguyễn Trãi.",
    isManagementUnit: false
  },
  {
    id: "org-helios-store-ba-hat",
    code: "SRG-002-012-004",
    name: "CH Bà Hạt",
    headId: null,
    parentId: "org-helios-sales",
    permissionStructure: "branch",
    departmentType: "branch",
    businessUnit: "sales",
    description: "Cửa hàng Helios tại Bà Hạt.",
    isManagementUnit: false
  },
  {
    id: "org-helios-store-new-playground",
    code: "SRG-002-012-005",
    ...
    departmentType: "branch",
    businessUnit: "sales",
    description: "Điểm bán Helios tại The New Playground.",
    isManagementUnit: false
  },
  {
    id: "org-helios-store-nguyen-gia-tri",
    code: "SRG-002-012-006",
    name: "CH Nguyễn Gia Trí",
    headId: null,
    parentId: "org-helios-sales",
    permissionStructure: "branch",
    departmentType: "branch",
    businessUnit: "sales",
    description: "Cửa hàng Helios tại Nguyễn Gia Trí.",
    isManagementUnit: false
  },
  {
    id: "org-ofthesun",
    ...
    permissionStructure: "branch",
    departmentType: "branch",
    businessUnit: "ofthesun",
    description: "Khối kinh doanh Ofthesun.",
    isManagementUnit: true
  },
  {
    id: "org-ofthesun-marketing",
    code: "SRG-003-001",
    name: "Phòng MKT",
    headId: null,
    parentId: "org-ofthesun",
    permissionStructure: "department",
    departmentType: "department",
    businessUnit: "marketing",
    description: "Phụ trách marketing cho Ofthesun.",
    isManagementUnit: false
  },
  {
    id: "org-ofthesun-store-nguyen-viet-xuan",
    code: "SRG-003-002",
    name: "CH Nguyễn Viết Xuân",
    headId: null,
    parentId: "org-ofthesun",
    permissionStructure: "branch",
    departmentType: "branch",
    businessUnit: "sales",
    description: "Cửa hàng Ofthesun tại Nguyễn Viết Xuân.",
    isManagementUnit: false
  },
  {
    id: "org-mdj",
    ...
    departmentType: "branch",
    businessUnit: "mdj",
    description: "Khối kinh doanh MDJ.",
    isManagementUnit: true
  }
];
