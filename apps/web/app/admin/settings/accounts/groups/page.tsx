import { UserGroupListBoard } from "@/components/admin/user-group-list-board";
...
export default async function UserGroupSettingsPage() {
  ...
  return (
    <UserFrame activeModule="admin" showSearch title="Danh sách nhóm">
      <UserGroupListBoard data={accountAccessData} />
    </UserFrame>
  );
}
